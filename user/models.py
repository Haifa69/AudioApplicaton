...
class Record(models.Model):
    ...
    shiek= models.CharField(max_length=100, choices=shiekh_choices, default='mohamend')
    juza=models.CharField(max_length=100, choices=juz_CHOICES, default='1')
    surah= models.CharField(max_length=100, choices=surah_choices, default='Albqara')
